...
<%
	//基本參數
	String code = "career_exploration"; 	// 模組識別碼
	String show_title ="技職試探常設展";	// 模組標題
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<tr align="center" class="web_table-2-1">
								...
								<td width="65%" align="center"><%=show_title%>名稱</td>								
							...
							<form name="form<%=i + 1%>" method="post">
								<tr class="web_table-2-1">
									...
									<td align="left">
										...
										<%} %>
										<input type="hidden" name="dm_id" value="<%=dm.getString("dm_id")%>">
										<input type="button" value="內文維護" onClick="goaction(this.form,'<%=code%>_content.jsp')">
