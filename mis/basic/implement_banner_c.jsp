...
<%
	//基本參數
	String code = "implement_banner"; 					// 模組識別碼
	String show_title = "實作環境輪播";				// 模組標題
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							<tr>
								<td align="center" colspan="4" class="web_title-1"><%=show_title%>維護&nbsp;&nbsp;
									...
									<%} %>
									<%if (sort_switch) { %>
									<input type="button" value="資料排序" onclick="javascript:location.href='<%=code%>_sort.jsp?cp_id=<%=cp_id %>'" />
									<%} %>
								</td>
							</tr>							
