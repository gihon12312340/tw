...
Zone[3] = new Array("請選擇", "萬里區", "金山區", "板橋區", "汐止區", "深坑區", "石碇區", "瑞芳區",
		...
		"三芝區", "石門區");
// for "宜蘭縣"
Zone[4] = new Array("請選擇", "宜蘭市", "頭城鎮", "礁溪鄉", "壯圍鄉", "員山鄉", "羅東鄉", "三星鄉", "大同鄉",
		"五結鄉", "冬山鄉", "蘇澳鎮", "南澳鄉");
// for "新竹市"
Zone[5] = new Array("請選擇","東區","北區","香山區");
// for "新竹縣"
Zone[6] = new Array("請選擇", "竹北市", "湖口鄉", "新豐鄉", "新埔鄉", "關西鄉", "芎林鄉", "寶山鄉", "竹東鄉",
		"五峰鄉", "橫山鄉", "尖石鄉", "北埔鄉", "峨嵋鄉");
// for "桃園市"
...
Zone[9] = new Array("請選擇", "中區", "東區", "南區", "西區", "北區", "北屯區", "西屯區", "南屯區",
		...
		"大安區");
// for "彰化縣"
Zone[10] = new Array("請選擇", "彰化市", "芬園鄉", "花壇鄉", "秀水鄉", "鹿港鎮", "福興鄉", "線西鄉", "和美鄉",
		"伸港鄉", "員林鎮", "社頭鄉", "永靖鄉", "埔心鄉", "溪湖鎮", "大村鄉", "埔鹽鄉", "田中鎮", "北斗鎮", "田尾鄉", "埤頭鄉",
...
Zone[16] = new Array("請選擇", "新興區", "前金區", "苓雅區", "鹽埕區", "鼓山區", "旗津區", "前鎮區",
		...
		"茄萣區");
// for "澎湖縣"
Zone[17] = new Array("請選擇", "馬公", "西嶼", "望安", "七美", "白沙", "湖西");
// for "屏東縣"
Zone[18] = new Array("請選擇", "屏東市", "三地門", "霧臺鄉", "瑪家鄉", "九如鄉", "里港鄉", "高樹鄉", "鹽埔鄉",
