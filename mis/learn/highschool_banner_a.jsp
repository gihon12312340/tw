...
<%
	//基本參數
	String code = "highschool_banner"; 					// 模組識別碼
	String show_title = "升學技高中十五群科輪播";				// 模組標題
	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=A&cp_id=<%=cp_id %>" onsubmit="javascript:return checkform(this);">
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="market_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="ap_alt" id="ap_alt" cols="118" rows="8" style="width: 855px;height: 46px;"></textarea>
								</td>
							</tr>
							<tr class="market_table-2-1">
							...
							<% if(mobile_image){ %>
							<tr class="market_table-2-1">
								<td align="right" class="market_table-2-1">手機輪播圖檔</td>
								<td colspan="3" align="left" class="tablebg">
