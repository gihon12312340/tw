				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3"
							...
							<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=S&cp_id=<%= cp_id  %>" onsubmit="javascript:return checkformsequ(this);">
							<tr class="web_table-2-1">
