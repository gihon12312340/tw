...
<%
	// 基本參數
	String code = "five_yearcollege"; // 模組識別碼
	String upload_code = "five_yearcollege"; // 上傳資料夾識別碼
	String show_title = "升學五專資訊"; // 模組標題
					...
					<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&cp_id=<%=cp_id%>">
						<table width="95%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td align="left" valign="middle" class="market_bigword"><%=show_title%>維護
								</td>
							</tr>
							<tr>
								<td colspan="2">
