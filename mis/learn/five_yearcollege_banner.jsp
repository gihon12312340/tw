...
<%
	// 基本參數
	String code = "five_yearcollege_banner"; 					// 模組識別碼
	String show_title = "升學五專輪播";				// 模組標題
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<%if(!search_switch){ %>
						<tr>
							<td align="center" colspan="6" class="market_title-1"><%=show_title%>維護&nbsp;&nbsp;
								<%if (add_switch) { %>
								<input type="button" value="新增資料" onclick="javascript:location.href='<%=code%>_a.jsp'" />&nbsp;
								<%} %>
								<%if (list_switch) { %>
						...
						<%}else{ %>
						<tr>
							<td align="center" colspan="6" class="market_title-1"><%=show_title%>查詢列表&nbsp;&nbsp;
						</tr>
						<%} %>
						<tr align="center" class="market_bk-2">
						...
						<td class="market_bk-2" colspan="6" align="center" height="26px">
