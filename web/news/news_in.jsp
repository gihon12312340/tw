...
//最新消息資料
String np_id = request.getParameter("np_id");
TableRecord np = app_sm.select(tblnp,np_id);
//圖片路徑(寫在tag裡很醜所以寫這)
String title="";
String content="";
String imgPath = app_fetchpath+"/"+page_code+"/"+lang+"/"+np.getString("np_image");
...
}else if("post_course".equals(np.getString("np_code"))){ //如果是會員發文，就去取發文的資料
	//System.out.println("post_course !!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
...
//人流統計
String setHistory  = IDTool.getUID("news_in", DateTimeTool.dateString(""), 6);
%>
