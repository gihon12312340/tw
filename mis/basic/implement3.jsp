...
<%
	//基本參數
	String code = "implement3"; 					// 模組識別碼
	String show_title = "實作環境參訪資訊維護";			// 模組標題
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">
							...
							<td align="center">
								...
								<%} %>
								<input type="button" value="輪播維護" onclick="location.href='implement_banner.jsp?cp_id=<%=cp.getString("cp_id") %>'" />
							</td>
						</tr>
						</form>
						<%} %>
