...
<%
String page_code = "activity_information_1"; //頁面識別碼
String ai_id = StringTool.validString(request.getParameter("ai_id"));
//System.out.println("ai_id: "+ai_id);
TableRecord ai = app_sm.select(tblai,ai_id);
//System.out.println("ai_id: "+ai.getString("ai_id"));
//活動資料
                    ...
                    <div class="right noleft"><!-- 右側_無左選單noleft -->
                        ...
                        <div class="containerIn">
                            ...
                            <div class="btn_area one"><!--如果只有一個按鍵時class內加one-->
                                <input type="button" value="線上報名" onclick="location='../implement/implement_sign.jsp?ai_id=<%=ai_id %>#implementId'"/>
