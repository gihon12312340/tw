...
/*------------------------------------------------------------------------------------*/	
	...
	boolean add_switch = false;//num_check(add_num,cps);
	...
	//關聯的會員發文資料
	TableRecord cp_post_course = app_sm.select(tblcp,cp.getString("cp_category"));
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="cp_title" id="cp_title" size="137" maxlength="120" value="<%=cp_post_course.getString("cp_title")%>" readonly/>
								</td>
							</tr>							
							<tr class="web_table-2-1">
								<td align="right">內文</td>
								<td colspan="3" align="left">
									<textarea name="cp_content" id="cp_content" cols="118" rows="8" readonly><%=cp_post_course.getString("cp_content")%></textarea>
									<%-- 
									<textarea name="cp_content" id="cp_content" cols="118" rows="8" class="mceEditor"><%=cp_post_course.getString("cp_content")%></textarea>
								    --%>
								</td>
							</tr>
							<tr class="web_table-2-1">
						        ...
						        <% if(!cp_post_course.getString("cp_image").isEmpty()){ %>
									<img src="<%=app_fetchpath+"/"+"post_course"+"/"+lang+"/"+cp_post_course.getString("cp_image")%>" width="198">		                      		
							    <% } %>
								</td>
		                    </tr>
		                    <%-- 
		                    <tr class="web_table-2-1">
								<td colspan="3" align="left" class="tablebg">
									...
									<input name="cp_image" id="cp_image" type="file" class="button" accept="image/*" onclick="frm.imgradio[1].checked=true;"> 
								</td>
		                    </tr>
                            --%>
							<%if(keyword_switch){ %>
