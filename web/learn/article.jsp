...
//人流統計用
String setHistory  = IDTool.getUID("article", DateTimeTool.dateString(""), 6);
%>
                                ...
                                <div class="learnBottomtext articleBottomtext">
                                    <div class="learnBottomtextIn">                                   
                                        <div class="indexAct_wrap">
                                            <!-- 首頁展場活動列表 -->
                                            <%Vector<TableRecord> cps = app_sm.selectAll(tblcp,"(cp_code=? OR cp_code=?) and cp_status=? and cp_lang=? and cp_category=?"
                                            		,new Object[]{page_code,"post_course","Y",lang,dm.getString("dm_id")}) ;
                                            int counter = 1;
                                        ...
                                        <!-- 更多內容 -->
                                        <div class="btnArea">
                                            <a href="../learn/article_list.jsp?dm_id=<%=dm.getString("dm_id")%>#learnId">
                                                more
                                            </a>
                                        </div>
