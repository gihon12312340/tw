...
<%
String page_code = "implement_news";
Vector<TableRecord> cps = app_sm.selectAll(tblcp,"cp_code=? and cp_lang=? and cp_status=?",new Object[]{page_code,lang,"Y"});
                        ...
                        <div class="implementArea">
                            ...
                            <ul class="">
                                ...
                                <li class="implementList">                                    
                                    <h3>
                                        <a href="../implement/latest_news_in.jsp?cp_id=<%=cp.getString("cp_id")%>">
                                            <%=cp_post_course.getString("cp_title") %>
                                        </a>
                                    </h3>
                                </li>
                               <%} %>
