...
<%
	// 基本參數
	String code = "activity_apply_1"; 			// 模組識別碼
...
/*------------------------------------------------------------------------------------------*/
	Vector aas = app_sm.selectAll(tblaa, "aa_code=? and aa_lang=?", new Object[] { "activity_information_1", lang }, "aa_createdate DESC");
	...
	if (search_switch) {
		...
		keys.add(lang);
		keys.add("activity_information_1");
