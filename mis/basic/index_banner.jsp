...
<%
	// 基本參數
	String code = "index_banner"; 			// 模組識別碼
	String upload_code = "index_banner"; 	// 上傳資料夾識別碼
	String show_title = "banner維護"; 			// 模組標題
										...
										<tr>
											<td class="system_bk-2bk">
												<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
													...
													<tr class="web_table-2-1">
									                    <td rowspan="2" align="right" class="web_table-2-1">新訊報報圖檔(電腦)</td>
		                                            ...
		                                            <tr class="web_table-2-1">
								                        <td colspan="3" align="left" class="tablebg">
									                        <input name="imgradio1" type="radio" value="ucpic" checked onclick="frm.cp_image.value='';">使用原圖<br>
									                        <input name="imgradio1" type="radio" value="new">上傳新圖
									                        <input name="cp_image" id="cp_image" type="file" class="button" accept="image/*" onclick="frm.imgradio1[1].checked=true;"> (建議尺寸 2500*1602)
								                        </td>
		                                            </tr>	
													
													
													<tr class="web_table-2-1">
									                    <td rowspan="2" align="right" class="web_table-2-1">新訊報報圖檔(手機)</td>
								                        <td colspan="3" align="left" class="tablebg">&nbsp;							 
									                        <img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+cp.getString("cp_mobile")%>" width="187">		                      		
								                        </td>
		                                            </tr>
		                                            <tr class="web_table-2-1">
								                        <td colspan="3" align="left" class="tablebg">
									                        ...
									                        <input name="cp_mobile" id="cp_mobile" type="file" class="button" accept="image/*" onclick="frm.imgradio2[1].checked=true;"> (建議尺寸 1333*3729)
								                        </td>
		                                            </tr>	
													<tr class="web_table-2-1">
														<td align="right">連結網址</td>
														<td colspan="3" align="left">
                                                           <input type="text" name="cp_url" id="cp_url" size="137" value="<%=cp.getString("cp_url")%>">
														</td>
													</tr>
