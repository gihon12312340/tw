...
<%
	//基本參數
	String code = "article"; 					// 模組識別碼
	String show_title = "技職好文資訊";			// 模組標題
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<%}else{ %>
						<tr>
							<td align="center" colspan="5" class="market_title-1"><%=show_title%>查詢列表&nbsp;&nbsp;
						</tr>
						<%} %>
						<tr align="center" class="market_bk-2">
						...
						<td class="market_bk-2" colspan="5" align="center" height="26px">
