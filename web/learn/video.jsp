...
//人流統計用
String setHistory  = IDTool.getUID("video", DateTimeTool.dateString(""), 6);
%>
                                    ...
                                    <div class="learnBottomtextIn">
                                        ...
                                        <div class="indexAct_wrap">
                                            <%Vector<TableRecord> cps = app_sm.selectAll(tblcp,"cp_code=? and cp_lang=? and cp_category=?",
                                            		                                     new Object[]{page_code,lang,dm.getString("dm_id")},
                                            		                                     "cp_showseq ASC,cp_createdate DESC LIMIT 5"); 
                                            int counter = 1;
                                        ...
                                        <!-- 更多內容 -->
                                        <div class="btnArea">
                                            <a href="../learn/video_list.jsp?dm_id=<%=dm.getString("dm_id")%>#learnId">
                                                more
                                            </a>
                                        </div>
