...
/*-------------------------------------------------------------------------*/
	...
	// 跳頁參數
	String[] names = new String[] { "cpage", "_qtitle", "_qcategory", "_qemitdate", "_qrestdate" };
	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&cp_id=<%=cp_id %>&_qtitle=<%=qtitle %>&cpage=<%=pageno %>&_qcategory=<%=qcategory %>&_qemitdate=<%=qemitdate %>&_qrestdate=<%=qrestdate %>" onsubmit="javascript:return checkform(this);">
