...
<%
	//基本參數
	String code = "activity"; 					// 模組識別碼
	String show_title = "展場活動資訊";			// 模組標題
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" width="85%" align="left">
									<input type="text" name="cp_title" id="cp_title" size="120" maxlength="120" />
								</td>
							</tr>
							<tr class="web_table-2-1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left">
									<textarea name="cp_description" id="cp_description" cols="118" rows="3" maxlength="255" style="width: 800px;height: 46px;"><%=SiteSetup.getSetup("seo.description"+"."+lang).getString("ss_text") %></textarea>
								</td>
							</tr>
							<tr class="web_table-2-1">
								<td align="right">設定追蹤碼</td>
								<td colspan="3" align="left">
									<textarea name="cp_seo_track" id="cp_seo_track" cols="118" rows="3" style="width: 800px;height: 46px;"><%=SiteSetup.getSetup("seo.track"+"."+lang).getString("ss_text") %></textarea>
								</td>
							</tr>
							<%} %>
							<%if(deadline_switch){ %>
