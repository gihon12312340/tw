	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&ap_id=<%=ap_id %>&_qemitdate=<%=qemitdate %>&_qrestdate=<%=qrestdate %>&dm_id=<%=dm_id %>" onsubmit="javascript:return checkform(this);">
