...
<%
	//基本參數
	String code = "university"; 					// 模組識別碼
	String show_title = "技職二十群類";			// 模組標題
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						cellspacing="1">
						<tr>
							<td align="center" colspan="2" class="market_title-1"><%=show_title%>維護&nbsp;&nbsp;
								<%if (add_switch) { %>
			...
			<tr>
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<%}else{ %>
						<tr>
							<td align="center" colspan="3" class="market_title-1"><%=show_title%>查詢列表&nbsp;&nbsp;
						</tr>
						<%} %>
						<tr align="center" class="market_bk-2">
						...
						<tr class="market_table-2-1">
							...
							<td align="center">
								...
								<%} %>								
								<input type="button" value="輪播維護" onclick="goaction(this.form,'<%=code+"_banner.jsp"%>');">
						...
						<td class="market_bk-2" colspan="3" align="center" height="26px">
