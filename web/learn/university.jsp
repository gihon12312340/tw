...
//人流統計用
String setHistory  = IDTool.getUID("university", DateTimeTool.dateString(""), 6);
%>
...
function goaction(FORM,JSP){
    ...
    FORM.submit();
                        ...
                        <ul class="school_bar">
                            ...
                            <li>
                                <a href="javascript: goaction(document.forms['frm1<%=counter++ %>'],'./university.jsp#learnId')">
