...
function checkform(F){
    ...
    <% } %>
        <%--
    } else if (chnese_chk.test(F.ap_mobile.value)) {
        alert("檔案名稱不可有包含中文!!");
        F.ap_mobile.focus();
	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=A&dm_id=<%=dm_id %>" onsubmit="javascript:return checkform(this);">
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<input type="hidden" name="ap_category" value="<%=dm_id%>">
