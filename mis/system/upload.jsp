...
<%
	    ...
	    if (files != null && !files.isEmpty()) {
	        ...
	        */
	        ...
	        upBean.store(mrequest, "image");
			//response.sendRedirect("lister.jsp?path="+uploadpath+"&type="+type+"&filename="+fileName);
	...
	//建立資料夾
	    ...
	    //response.sendRedirect("lister.jsp?path="+uploadpath+"/"+mrequest.getParameter("folder"));
	}
%>
