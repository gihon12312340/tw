...
<%
	// 基本參數
	String code = "count2"; 			// 模組識別碼
	String upload_code = "count2"; 	// 上傳資料夾識別碼
												...
												<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
													...
													<tr class="web_table-2-1">
														...
														<td colspan="4" width="30%" align="left">
															<input type="number" name="na_imp2" id="na_imp2" size="137" maxlength="120" value="<%=na.getInt("na_imp2")%>"
															min="0" oninput="value=value.replace(/[^\d]/g,'')"/>
														</td>
														<td width="15%" align="right">報名參訪體驗資訊<br>瀏覽人次</td>
														<td colspan="4" width="45%" align="left">
															<input type="number" name="na_imp2_2" id="na_imp2_2" size="137" maxlength="120" value="<%=na.getInt("na_imp2_2")%>"
															min="0" oninput="value=value.replace(/[^\d]/g,'')"/>
														</td>
													</tr>
													<tr class="web_table-2-1">
