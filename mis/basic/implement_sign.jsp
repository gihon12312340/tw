...
<%
	// 基本參數
	String code = "implement_sign"; 			// 模組識別碼
	String show_title = "報名紀錄維護";		// 模組標題	
...
/*------------------------------------------------------------------------------------------*/
	Vector aas = app_sm.selectAll(tblaa, "aa_code=? and aa_lang=?", new Object[] { code, lang }, "aa_createdate DESC");
				...
				<table width="95%" border="0" cellspacing="1" cellpadding="0">
					...
					<table width="100%" border="0" align="center" cellpadding="3"
						...
						<tr class="web_table-2-1">
						    ...
						    <td width="20%" align="center">報名日期</td>
