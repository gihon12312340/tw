...
<%
	...
	String upload_code = "carrer_exploration"; // 上傳資料夾識別碼
...
/*--------------------------------------------------------------------------------------*/		
	Vector cps = app_sm.selectAll(tblcp, "cp_code=? and cp_lang=? and cp_category=?", 
			                     new Object[] { code, lang ,dm_id}, "cp_showseq ASC , cp_createdate DESC");	
	...
	if(single){
		...
		// 單網編 直接抓功能代號
		cp = app_sm.select(tblcp, "cp_code=? and cp_lang=? and cp_category=?",new Object[]{code,lang,dm_id});
		...
		<table width="1280" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td width="1125" align="center" valign="top" class="system_bk-2p">
					<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&cp_id=<%=cp_id%>&dm_id=<%=dm_id%>">
											...
											<td class="system_bk-2bk">
												<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
		                                           ...
		                                           <tr class="web_table-2-1">
													...
													<tr class="web_table-2-1">
														<td width="15%" align="right">標題1</td>
													...
													<tr class="web_table-2-1">
														<td width="15%" align="right">標題3</td>
														<td colspan="3" width="85%" align="left">
															展演活動
															<%--
															<input type="text" name="cp_title" id="cp_title" size="137" maxlength="120" value="<%=cp.getString("cp_title")%>"/>
													...
													<tr class="web_table-2-1">
														...
														<td colspan="4" align="left">
															<textarea name="cp_content3" id="cp_content3" cols="118" rows="8" class="mceEditor"><%=cp.getString("cp_content3")%></textarea>
														</td>
													</tr>
													<tr class="web_table-2-1">
														<td width="15%" align="right">標題4</td>
														<td colspan="3" width="85%" align="left">
															聯絡資訊
															<%--
															<input type="text" name="cp_title" id="cp_title" size="137" maxlength="120" value="<%=cp.getString("cp_title")%>"/>
													...
													<tr class="web_table-2-1">
														...
														<td colspan="4" align="left">
															<textarea name="cp_content4" id="cp_content4" cols="118" rows="8" class="mceEditor"><%=cp.getString("cp_content4")%></textarea>
														</td>
													</tr>
