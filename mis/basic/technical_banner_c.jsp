...
<%
	//基本參數
	String code = "technical_banner"; 					// 模組識別碼
	String show_title = "技職教育好夥伴輪播";				// 模組標題
...
/*--------------------------------------------------------------------------------------*/	
	Vector aps = app_sm.selectAll(tblap, "ap_code=? and ap_lang=? ap_category=?", new Object[] { code, lang,cp_id}, "ap_showseq ASC , ap_createdate DESC");
	...
	<tr>
		...
		<table width="95%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<form name="frm" id="frm" method="post" enctype="multipart/form-data" action="<%=code%>_update.jsp?action=M&ap_id=<%=ap_id %>&cp_id=<%=cp_id %>&_qemitdate=<%=qemitdate %>&_qrestdate=<%=qrestdate %>" onsubmit="javascript:return checkform(this);">
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
							...
							<tr class="web_table-2-1">
								...
								<td colspan="3" align="left" class="tablebg">&nbsp;							 
									<img src="<%=app_fetchpath+"/"+code+"/"+lang+"/"+ap.getString("ap_image")%>" width="50%">		                      		
								</td>
		                    </tr>
		                    <tr class="web_table-2-1">
								<td colspan="3" align="left" class="tablebg">
